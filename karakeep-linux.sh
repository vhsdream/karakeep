...
install_karakeep() {
  ...
  DEBIAN_FRONTEND=noninteractive $shh dpkg -i meilisearch.deb && rm meilisearch.deb
...
EOF
  ...
  msg_info "OK, $(app) should be accessible at ${YELLOW}http://${LOCAL_IP}:3000${CLR}"
